...
public class ModuleIOTalonFX implements ModuleIO {
  ...
  public ModuleIOTalonFX(
    ...
    driveTalon = new TalonFX(constants.DriveMotorId, TunerConstants.CAN_BUS);
    turnTalon = new TalonFX(constants.SteerMotorId, TunerConstants.CAN_BUS);
    cancoder = new CANcoder(constants.EncoderId, TunerConstants.CAN_BUS);
